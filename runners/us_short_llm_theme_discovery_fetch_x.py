...
def _bind_live_runner(run_impl: Callable[..., Any], new_transport: Callable[..., object], issue_ticket: Callable[[], object], revoke_ticket: Callable[[object], None]) -> Callable[..., Any]:
    ...
    def runner(*, queries: list[str] | tuple[str, ...] | None, expected_decision_date: str, generated_at: str, x_client: Any | None = None, confirm_user_authorization: bool = False, live: bool = False, raw_root: Path = DEFAULT_RAW_ROOT, # Same Class-A allowlist: offline mode may omit the plan.
