...
if ($SkipRegime) {
    ...
    $RegimeArgs += @('--loss-making-run-revision-id', $RunRevisionId,
                     '--loss-making-rank-csv', $LossMakingRankCsv,
