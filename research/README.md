...
- `research/preregistrations/a_short_steady_alpha_reaudit_20260603.json` - preregistered A-short steady-lane alpha re-audit. It freezes the same-anchor 5d / 20d CSI1000 / CSI300 plan, multiple-testing / slice / factor / veto / PIT checks, and decision labels. It does not run outcomes; a future run still needs independent review and an explicit user execute command.
...
- `research/ledgers/a_short_steady_alpha_reaudit_program_test_budget_ledger_20260603.json` - singleton planned-test ledger for the A-short steady re-audit. It records zero spent tests and one planned test; the future outcome run is not authorized until review passes and the user executes it.
