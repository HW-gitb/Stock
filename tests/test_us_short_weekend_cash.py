...
class ApplyCashAllocationTests(unittest.TestCase):
    ...
    def test_malformed_build_inputs_raise(self):
        ...
        with self.assertRaises(wc.WeekendCashError):
            wc.apply_cash_allocation(_result([bad_rank]), available_cash=5000.0)
