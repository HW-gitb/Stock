...
def _artifact():
    return {
        "schema_name": "us_short_provisional_theme_validation", "schema_version": "1.0.0", "generated_at": "2026-06-15T11:00:00+00:00",
        ...
        "themes": [{"theme_id": "theme_01", "display_name": "Theme", "summary": "Validated.", "status": "provisional_validated", "observed_at": "2026-06-12T12:10:00+00:00", "source_ref_ids": ["web:theme", "x:theme"], "cross_industry_validation_status": "validated_by_sec_sic_major_group", "market_confirmation_status": "not_run", "validation": {"selection_rank": 1, "qualified_member_count": 3, "industry_count": 2, "industry_codes": ["10", "20"], "source_type_counts": {"web": 3, "x": 3, "both": 3}}, "members": [{"ticker": ticker, "membership_status": "provisional_validated", "source_ref_ids": ["web:theme", "x:theme"], "source_types": ["web", "x"], "evidence_tier": "both", "industry_code": code, "industry_source": "sec_sic_major_group"} for ticker, code in (("AAPL", "10"), ("MSFT", "10"), ("JPM", "20"))]}],
        "drop_ledger": [], "summary": {"discovered_theme_count": 1, "validated_theme_count": 1, "validated_member_count": 3, "rejected_theme_count": 0, "dropped_member_count": 0, "truncated_theme_count": 0},
    }
