...
SUMMARY_SCHEMA_PATH = Path("schemas/a_long_large_cap_cash_conversion_signal_search_execution_summary.schema.json")


class ALongLargeCapCashConversionSignalSearchSchemaTest(unittest.TestCase):
        ...
        for view in ["industry_size_neutral", "non_neutral", "industry_neutral", "size_neutral"]:
            for horizon in [252, 504]:
                for benchmark in ["CSI300", "CSI1000"]:
                    specs.append(("cash_conversion", view, "equal_weight", horizon, benchmark))
        for horizon in [252, 504]:
            for benchmark in ["CSI300", "CSI1000"]:
                specs.append(("cash_conversion", "industry_size_neutral", "cap_weighted", horizon, benchmark))
        for signal_id in ["profitability_quality", "balance_sheet_strength", "earnings_stability"]:
            for horizon in [252, 504]:
                for benchmark in ["CSI300", "CSI1000"]:
    ...
    def _valid_summary(self) -> dict:
        return {
            ...
            "artifact_id": "a_long_large_cap_cash_conversion_signal_search_execution_summary_20260607",
            "source_refs": [
                "research/preregistrations/a_long_large_cap_cash_conversion_20260607.json",
                "research/ledgers/a_long_large_cap_cash_conversion_program_test_budget_ledger_20260607.json",
            ...
            "search_design": {
                ...
                "cash_conversion_views_reported": ["industry_size_neutral", "non_neutral", "industry_neutral", "size_neutral"],
            ...
            "decision": {
                "research_verdict": "falsified_large_cap_cash_conversion_under_frozen_rules",
                "is_statistical_alpha_clue": False,
                "is_tradeable_candidate": False,
                "statistical_alpha_clue_count": 0,
                "tradeable_candidate_count": 0,
                "primary_cell_id": "cash_conversion_industry_size_neutral_equal_weight_504d_CSI300",
                ...
                "plain_result": "Large-cap cash_conversion is falsified under the frozen single-primary-cell design.",
            ...
            "ledger_update_required_after_commit": {
                "ledger_ref": "research/ledgers/a_long_large_cap_cash_conversion_program_test_budget_ledger_20260607.json",
                "spends_singleton_test": True,
                "test_id": "a_long_large_cap_cash_conversion_20260607",
            ...
            "result_artifacts": ["research/results/a_long_large_cap_cash_conversion_20260607/execution_summary.json"],
    ...
    def test_summary_schema_accepts_valid_shape(self) -> None:
        ...
        self.assertEqual(len(payload["result_cells"]), 32)
    ...
    def test_summary_schema_rejects_wrong_cell_count(self) -> None:
        invalid = copy.deepcopy(self._valid_summary())
        invalid["result_cells"] = invalid["result_cells"][:31]
    ...
    def test_summary_schema_rejects_duplicate_primary_role(self) -> None:
        ...
        for cell in invalid["result_cells"]:
            if cell["cell_id"] != "cash_conversion_industry_size_neutral_equal_weight_504d_CSI300":
