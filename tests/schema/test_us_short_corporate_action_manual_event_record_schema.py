...
def valid_confirmed() -> dict:
    return {
        ...
        "boundary": {"provider_call_performed": False, "raw_payload_read": False, "account_state_read": False, "account_state_mutated": False, "broker_order_placed": False, "selection_or_ranking_changed": False, "ship_gate_evidence_claimed": False},
    }
...
class CorporateActionManualEventRecordSchemaTest(unittest.TestCase):
    ...
    def test_confirmation_event_and_boundary_cannot_drift(self):
        for path, value in (
            ...
            (("boundary", "account_state_read"), True),
