...
class MassiveNewsCatalystBindingSchemaTest(unittest.TestCase):
    ...
    def test_us_short_massive_news_catalyst_binding_schema_rejects_load_bearing_const_drift(self):
        mutants = [
            ...
            (["input_contract", "provenance_required_keys"], ["provider_id"]),
            (["input_contract", "source_as_of_policy"], "free_clock"),
            (["input_contract", "emission_fitness"], "any_checked_row_scores"),
            (["input_contract", "lineage_ref_format"], "free_text"),
