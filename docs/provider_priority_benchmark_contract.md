...
Phase 7b-2 has started with five P1 snapshots: `docs/provider_evidence_p1_us_public_sources_20260528.json` for SEC EDGAR submissions/XBRL, SEC ticker files, Nasdaq symbol directory, and GICS methodology; `docs/provider_evidence_p1_us_market_data_candidates_20260528.json` for Massive / Polygon and Norgate US market-data candidate documentation; `docs/provider_evidence_p1_us_authorization_cost_stability_20260528.json` for Massive / Polygon and Norgate pricing, API-key / subscription / trial access, license / EULA, export / retention, stability constraints, and Norgate current-fundamentals latest-only limitations; `docs/provider_evidence_p1_us_benchmark_gics_candidates_20260528.json` for S&P DJI / Nasdaq / FTSE Russell / LSEG benchmark methodology and S&P Global / MSCI GICS candidate evidence; and `docs/provider_evidence_p1_us_fundamentals_observed_date_candidates_20260528.json` for SEC EDGAR public reconstruction, Intrinio filing fundamentals, FMP SEC filings / as-reported statements, and Nasdaq Data Link / Sharadar fundamentals candidate context. These snapshots make P1 `partial`, not implementation-ready. Phase 7b-2 still needs to continue actual provider capability evidence in the P1 to P4 order above: coverage counts, fallback behavior, incident / stability evidence, unresolved fundamentals field-level license / sample-row validation, and limitations before moving to P2-P4.
