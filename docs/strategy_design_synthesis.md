...
6. Phase 7b-2: continue provider capability evidence in the P1-P4 queue; do not treat the P1 public-source or market-data-candidate snapshots as provider selection or implementation readiness.
