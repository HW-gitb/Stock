...
6. Phase 7b-2: continue provider capability evidence in the P1-P4 queue; do not treat the P1 public-source, market-data-candidate, or authorization / cost / stability snapshots as provider selection or implementation readiness.
