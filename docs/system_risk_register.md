...
Temporary US free-data working-boundary update: this is the current cost-saving operating posture, not a final provider or spending decision. The user may at any time decide to buy / connect a specialized source such as EODHD, Norgate, Sharadar, or paid FMP; reassess when a US idea shows forward-live promise or when the user asks. Until inactive / delisted security master, PIT fundamentals, price adjustment / corporate actions, license / storage, fallback / stability, and production-readiness blockers are closed or explicitly accepted, US work may continue only as FMP Basic / SEC EDGAR exploration, paper, minimal-size, and live-normalized forward-evidence accumulation. US historical backtests are reference-only and cannot prove alpha, justify full-size manual use, authorize DataHub / Phase 7c, or count as ship-gate evidence. The A-share 35% / US 65% capital policy is not automatically rewritten; unvalidated US allocation stays in US cash / paper / minimal buckets unless the user makes an explicit manual transfer decision.

1. `SR-DATA-004` - Maintenance watch item before affected subsystem promotion; requires real weekly suspend-coverage logs.
2. `SR-PROVIDER-001` - Use the remaining-blocker plan, fallback playbook, incident-log contract, license / storage / retention review, SEC parser scope contract, SEC field-family mapping contract, FMP PIT semantics contract, FMP price/corporate-action semantics contract, coverage-count plan / summary, missing key-metrics resolution plan, 2026-06-03 validation authorization / execution packet / execution summary, inactive / delisted gap resolution plan, FMP entitlement / corporate-action no-access diagnostic, SIVB-only re-probe packet / execution summary, and FMP paid-tier / license public-docs review before any provider work. The validation execution summary, diagnostic, SIVB re-probe summary, and public-docs review record bounded response-shape / field-presence / public-doc / 402 category-signal clues only; SIVB remains 5/5 HTTP 402 with weak `historical_or_delisted_paid_tier` category signal, not paid-wall proof, not inactive / delisted coverage proof, and not provider readiness. Public paid-tier signals do not prove SIVB access, inactive / delisted coverage, license clearance, or storage rights. TWTR / SIVB SEC CIK follow-up skips remain unresolved, missing key-metrics direct fields remain unresolved, and split / dividend endpoint templates are identified but not called or entitled. Broader coverage-count execution, any SIVB scope beyond the fixed evidence, current terms / production storage rights, inactive / delisted security-master / lifecycle evidence, field-level PIT validation, actual price adjustment / corporate actions, actual SEC parser implementation and field mapping, minimized fixture policy, derivation lineage, incident-log writer, executed fallback / incident behavior, stability evidence, and production-readiness evidence remain required before any new token / trial / paid access / account change / provider contact / `yfinance` check / broader FMP or SEC endpoint call / fixture generation / derivation or field-mapping implementation / return calculation / corporate-action reconciliation / full-market fetch / provider status polling / provider selection / adapter / DataHub / runner consumption / Phase 7c use.
## Entries
...
- Accepted calibration: the approval, SEC sample run, FMP mapping review, FMP stable retry, remaining-blocker plan, fallback playbook, incident-log contract, license / storage / retention review, SEC parser scope contract, SEC field-family mapping contract, FMP PIT semantics contract, FMP price/corporate-action semantics contract, coverage-count access-packet plan, bounded coverage-count execution summary, missing key-metrics resolution plan, 2026-06-03 validation authorization / execution packet, validation execution summary, inactive / delisted gap resolution plan, FMP entitlement / corporate-action diagnostic, SIVB re-probe execution summary, FMP paid-tier / license public-docs review, and temporary US free-data working boundary prove only narrow two-symbol access / response-shape, a five-active-symbol FMP stable coverage smoke, a no-access missing-field route, user authorization and execution of a bounded validation packet, response-shape / field-presence clues for that five-symbol sample, no-access routing for the inactive / delisted blocker, docs-only split / dividend template candidates, a weak category signal for SIVB's 5/5 HTTP 402 behavior, public-page route signals for Basic active-only / paid FMP / specialized-source choices, and a temporary cost-saving boundary for exploration / forward evidence only. They do not prove inactive / delisted coverage, paid-tier SIVB access, current terms clearance, production storage rights, direct ratio availability, safe derived ratios, field-level PIT validation at scale, price adjustment at scale, live corporate-action endpoint access / entitlement, corporate-action reconciliation at scale, SIVB paid-wall status, SEC parser feasibility at scale, historical security-master correctness, minimized fixtures, executable fallback behavior, provider stability, provider selection, DataHub / runner consumption, Phase 7c, production readiness, alpha validation, full-size US sizing, or ship-gate evidence.
- Required next action: do not rerun or broaden the sample silently. Use the remaining-blocker plan, fallback playbook, incident-log contract, license-storage review, SEC parser / field-family contracts, FMP PIT / price semantics contracts, coverage-count plan / approval / summary, missing key-metrics resolution plan, validation authorization packet, validation execution packet, validation execution summary, inactive / delisted gap resolution plan, FMP entitlement / corporate-action diagnostic, SIVB re-probe execution summary, FMP paid-tier / license public-docs review, and temporary US free-data working boundary as routing sources. Any SIVB scope beyond the fixed evidence, current terms legal review, paid upgrade, account change, provider contact, FMP split / dividend endpoint call, inactive / delisted follow-up call, raw-payload read / parse outside a reviewed packet, fixture generation, security-master implementation, derivation implementation, return calculation, corporate-action reconciliation, field-mapping or parser implementation, new token, trial, paid access, `yfinance` check, full-market download, provider status polling, provider selection, adapter, DataHub table, runner consumption, fallback execution, incident-log writer implementation, Phase 7c use, production-readiness claim, ship-gate claim, or full-size US sizing requires separate explicit approval and reviewed decision. Reassess paid / specialized data when a US idea shows forward-live promise or when the user asks. Remaining P1 provider work must address legal / user terms judgment, production storage rights, inactive-delisted security-master source, actual FMP PIT row validation, actual FMP price adjustment and corporate-action validation, actual SEC parser implementation and field mapping, minimized fixtures, derivation lineage, incident-log writer, executable fallback, and stability evidence before implementation can consume FMP.
