...
1. `SR-DATA-003` - Resolve benchmark-open input before any redesigned A-share burst outcome / excess calculation, and fix the forward-tracker cache guard before official backfill use.
