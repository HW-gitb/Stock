...
2. `SR-ALPHA-001` - Resolved for the current 5d clue: the repaired same-anchor test failed before promotion, so the prior direct-regime blocker no longer carries an active candidate.
