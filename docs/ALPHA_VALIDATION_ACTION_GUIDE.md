...
The repaired A-short steady same-anchor re-audit has run and spent its one planned test. Plain result: the old 5d CSI1000 clue did not survive the corrected statistical gate; A-short steady remains risk-filter-only / research reference. The next A-share alpha-validation step is independent review of that repaired outcome; after a clean review and commit, any new alpha search must be a new reviewed preregistration, not a rerun or parameter rescue.
