...
| Phase 7b-2 follow-up | start A-share minimal-data burst research-only falsification with preregistration; do not route US-long SEC parser feasibility as alpha validation |
