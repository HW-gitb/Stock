...
| DataHub / provider / factor-layer guardrails and local resource budget / job-spec precondition before Phase 7c implementation | `docs/datahub_design.md`, `schemas/datahub_local_resource_budget.schema.json`, `docs/datahub_local_resource_budget_contract_20260602.json`, `schemas/datahub_job_spec.schema.json`, `schemas/examples/datahub_job_spec.example.json` |
