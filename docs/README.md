...
| Research-only preregistration, preflight, and test-budget ledger artifacts | `research/README.md`, `schemas/research_preregistration.schema.json`, `schemas/research_preflight_result.schema.json`, `schemas/program_test_budget_ledger.schema.json`, `research/preregistrations/a_share_minimal_data_burst_20260531.json`, `research/preregistrations/a_share_minimal_data_burst_corrected_basis_20260531.json`, `research/results/a_share_minimal_data_burst_corrected_basis_20260531/preflight_zero_signal_events_20260531.json`, `research/ledgers/a_share_burst_program_test_budget_ledger_20260531.json` |
