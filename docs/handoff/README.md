...
- `2026-08-09_us_serenity_annotation_blade0_handoff.md` — Serenity `structural_theme_annotation` Blade 0/1 calibration、Blade 3/4 contract/consumer、Blade 5 quality-forward 与 Optional 收口；Blade 6 仍须实际 quality gate + G1 唯一映射授权，当前保持全 effect flags false；触及 Serenity 研究刀时打开。
