...
- `2026-08-09_us_serenity_annotation_blade0_handoff.md` — Serenity `structural_theme_annotation` Blade 0/1 calibration、Blade 3/4 contract/consumer 与 Blade 5 quality-forward weekly wiring；仍限 research/advisory，quality gate 不提供行为效果证据，保持全 effect flags false；触及 Serenity 研究刀时打开。
