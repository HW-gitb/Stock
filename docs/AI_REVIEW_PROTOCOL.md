...
- follow the checklist's single-window independent self-review schedule before handing work to Claude Code for `审查`, and record the short proof in the handoff entry
